...
var meanCmsSectionControllers = angular.module('meanCmsSectionControllers', []);

meanCmsSectionControllers.controller('SectionsCtrl', ['$scope', 'checkCreds', '$location', 'SectionList', '$http', 'getToken',
...
meanCmsSectionControllers.controller('DeleteSectionCtrl', ['$scope', 'Section', '$location', '$route', '$http', 'getToken',
...
meanCmsSectionControllers.controller('SectionAddCtrl', ['$scope', 'Section', '$location', '$http', 'getToken',
...
meanCmsSectionControllers.controller('NewSectionCtrl', ['$scope', 'checkCreds', '$location', "LanguageList", '$http', 'getToken',
