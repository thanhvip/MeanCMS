...
var meanCmsUserControllers = angular.module('meanCmsUserControllers', []);
meanCmsUserControllers.controller('UsersCtrl', ['$scope', 'checkCreds', '$location', 'UserList', '$http', 'getToken',
...
meanCmsUserControllers.controller('DeleteUserCtrl', ['$scope', 'User', '$location', '$route', '$http', 'getToken',
...
meanCmsUserControllers.controller('UserAddCtrl', ['$scope', 'User', '$location', '$http', 'getToken',
...
meanCmsUserControllers.controller('NewUserCtrl', ['$scope', 'checkCreds', '$location', "UserRoleList", '$http', 'getToken',
...
meanCmsUserControllers.controller('UserEditCtrl', ['$scope', 'User', '$location', '$http', 'getToken',
...
meanCmsUserControllers.controller('UserCtrl', ['$scope', 'checkCreds', '$location', "User", '$routeParams', '$http', 'getToken', 'UserRoleList',
...
meanCmsUserControllers.controller('PasswordCtrl', ['$scope', 'checkCreds', '$location', 'getUsername', '$http', 'getToken',
...
meanCmsUserControllers.controller('PasswordChangeCtrl', ['$scope', 'Password', '$location', 'setCreds', '$http', 'getToken', '$http', 'getToken',
