...
var meanCmsProductControllers = angular.module('meanCmsProductControllers', []);

meanCmsProductControllers.controller('ProductsCtrl', ['$scope', 'checkCreds', '$location', 'ProductList', '$http', 'getToken',
...
meanCmsProductControllers.controller('DeleteProductCtrl', ['$scope', 'Product', '$location', '$route', '$http', 'getToken',
...
meanCmsProductControllers.controller('ProductAddCtrl', ['$scope', 'Product', '$location', '$http', 'getToken',
...
meanCmsProductControllers.controller('NewProductCtrl', ['$scope', 'checkCreds', '$location', '$http', 'getToken', 'ArticleValues',
...
meanCmsProductControllers.controller('ProductEditCtrl', ['$scope', 'Product', '$location', '$http', 'getToken',
...
meanCmsProductControllers.controller('ProductCtrl', ['$scope', 'checkCreds', '$location', "Product", '$routeParams', '$http', 'getToken', 'ArticleValues',
