...
var meanCmsCategoryControllers = angular.module('meanCmsCategoryControllers', []);

meanCmsCategoryControllers.controller('CategoriesCtrl', ['$scope', 'checkCreds', '$location', 'CategoryList', '$http', 'getToken',
...
meanCmsCategoryControllers.controller('DeleteCategoryCtrl', ['$scope', 'Category', '$location', '$route', '$http', 'getToken',
...
meanCmsCategoryControllers.controller('CategoryAddCtrl', ['$scope', 'Category', '$location', '$http', 'getToken',
...
meanCmsCategoryControllers.controller('NewCategoryCtrl', ['$scope', 'checkCreds', '$location', "LanguageList", '$http', 'getToken',
