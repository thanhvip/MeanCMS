...
var meanCmsAddonsControllers = angular.module('meanCmsAddonsControllers', []);
meanCmsAddonsControllers.controller('AddonsCtrl', ['$scope', 'checkCreds', '$location', 'AddonsList', '$http', 'getToken',
...
meanCmsAddonsControllers.controller('DeleteAddonCtrl', ['$scope', 'Addons', '$location', '$route', '$http', 'getToken',
...
meanCmsAddonsControllers.controller('AddonsAddCtrl', ['$scope', 'Addons', '$location', '$http', 'getToken',
...
meanCmsAddonsControllers.controller('NewAddonsCtrl', ['$scope', 'checkCreds', '$location', '$http', 'getToken',
...
meanCmsAddonsControllers.controller('AddonEditCtrl', ['$scope', 'Addons', '$location', '$http', 'getToken',
...
meanCmsAddonsControllers.controller('AddonCtrl', ['$scope', 'checkCreds', '$location', "Addons", '$routeParams', '$http', 'getToken',
