...
var meanCmsAdminControllers = angular.module('meanCmsAdminControllers', []);

meanCmsAdminControllers.controller('MainCtrl', ['$scope', 'checkCreds', '$location', '$document', 'AdminSummary', '$http', 'getToken', 'DateUtil',
...
meanCmsAdminControllers.controller('MainCtrl2', ['$scope', '$routeParams', 'checkCreds', '$location', 'AdminSummary', '$http', 'getToken', 'DateUtil',
