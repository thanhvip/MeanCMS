...
var meanCmsArticleControllers = angular.module('meanCmsArticleControllers', []);

meanCmsArticleControllers.controller('ArticlesCtrl', ['$scope', 'checkCreds', '$location', 'ArticleList', 'DateUtil', '$http', 'getToken',
...
meanCmsArticleControllers.controller('ArticleCtrl', ['$scope', '$rootScope', '$routeParams', 'checkCreds',
...
meanCmsArticleControllers.controller('ArticleEditCtrl', ['$scope', '$rootScope', 'Article', '$location', 'setCreds', '$http', 'getToken',
...
meanCmsArticleControllers.controller('DeleteArticlesCtrl', ['$scope', '$rootScope', 'Article', '$location', '$route', '$http', 'getToken',
...
meanCmsArticleControllers.controller('UploadArticleCtrl', ['$scope', 'checkCreds', '$location', 'ArticleValues', '$http', 'getToken',
