...
var meanCmsConfigurationControllers = angular.module('meanCmsConfigurationControllers', []);

meanCmsConfigurationControllers.controller('ConfigurationsCtrl', ['$scope', 'checkCreds', '$location', 'ConfigurationList', '$http', 'getToken',
...
meanCmsConfigurationControllers.controller('DeleteConfigurationCtrl', ['$scope', 'Configuration', '$location', '$route', '$http', 'getToken',
...
meanCmsConfigurationControllers.controller('ConfigurationAddCtrl', ['$scope', 'Configuration', '$location', '$http', 'getToken',
...
meanCmsConfigurationControllers.controller('NewConfigurationCtrl', ['$scope', 'checkCreds', '$location', '$http', 'getToken', 'LanguageList',
...
meanCmsConfigurationControllers.controller('ConfigurationEditCtrl', ['$scope', 'Configuration', '$location', '$http', 'getToken',
...
meanCmsConfigurationControllers.controller('ConfigurationCtrl', ['$scope', 'checkCreds', '$location', "Configuration", '$routeParams', '$http', 'getToken', 'LanguageList',
