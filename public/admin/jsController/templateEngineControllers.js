...
var meanCmsTemplateEngineControllers = angular.module('meanCmsTemplateEngineControllers', []);

meanCmsTemplateEngineControllers.controller('TemplateEnginesCtrl', ['$scope', 'checkCreds', '$location', 'TemplateEngineList', '$http', 'getToken',
...
meanCmsTemplateEngineControllers.controller('TemplateEngineCtrl', ['$scope', 'checkCreds', '$location', "TemplateEngine", '$routeParams', '$http', 'getToken',
...
meanCmsTemplateEngineControllers.controller('TemplateEngineEditCtrl', ['$scope', 'TemplateEngine', '$location', '$http', 'getToken',
