...
var meanCmsNewArticleControllers = angular.module('meanCmsNewArticleControllers', []);
meanCmsNewArticleControllers.controller('NewArticlesCtrl', ['$scope', '$rootScope', 'checkCreds', '$location', 'ArticleValues', '$http', 'getToken',
...
meanCmsNewArticleControllers.controller('ArticleAddCtrl', ['$scope', '$rootScope', 'Article', '$location', 'setCreds', '$http', 'getToken',
