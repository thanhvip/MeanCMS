...
var meanCmsLinkControllers = angular.module('meanCmsLinkControllers', []);

meanCmsLinkControllers.controller('LinksCtrl', ['$scope', 'checkCreds', '$location', 'LinkList', '$http', 'getToken',
...
meanCmsLinkControllers.controller('DeleteLinkCtrl', ['$scope', 'Link', '$location', '$route', '$http', 'getToken',
...
meanCmsLinkControllers.controller('LinkAddCtrl', ['$scope', 'Link', '$location', '$http', 'getToken',
...
meanCmsLinkControllers.controller('NewLinkCtrl', ['$scope', 'checkCreds', '$location', '$http', 'getToken', "LanguageList",
...
meanCmsLinkControllers.controller('LinkEditCtrl', ['$scope', 'Link', '$location', '$http', 'getToken',
...
meanCmsLinkControllers.controller('LinkCtrl', ['$scope', 'checkCreds', '$location', "Link", '$routeParams', '$http', 'getToken', 'LanguageList',
