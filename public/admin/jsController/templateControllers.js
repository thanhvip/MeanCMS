...
var meanCmsTemplateControllers = angular.module('meanCmsTemplateControllers', []);

meanCmsTemplateControllers.controller('TemplatesCtrl', ['$scope', 'checkCreds', '$location', 'TemplateList', '$http', 'getToken',
...
meanCmsTemplateControllers.controller('TemplateCtrl', ['$scope', 'checkCreds', '$location', "Template", '$routeParams', '$http', 'getToken',
...
meanCmsTemplateControllers.controller('TemplateEditCtrl', ['$scope', 'Template', '$location', '$http', 'getToken',
...
meanCmsTemplateControllers.controller('TemplateAddCtrl', ['$scope', 'Template', '$location', '$http', 'getToken',
...
meanCmsTemplateControllers.controller('NewTemplateCtrl', ['$scope', 'checkCreds', '$location', '$http', 'getToken',
...
meanCmsTemplateControllers.controller('UploadTemplateCtrl', ['$scope', 'checkCreds', '$location', '$http', 'getToken', "ArticleValues",
...
meanCmsTemplateControllers.controller('DeleteTemplateCtrl', ['$scope', '$rootScope', 'Template', '$location', '$route', '$http', 'getToken',
