...
var meanCmsCommentsControllers = angular.module('meanCmsCommentsControllers', []);
meanCmsCommentsControllers.controller('CommentsCtrl', ['$scope', 'checkCreds', '$location', 'CommentList', '$http', 'getToken',
...
meanCmsCommentsControllers.controller('CommentCtrl', ['$scope', "$routeParams", 'checkCreds', 'Comment', '$location', '$http', 'getToken',
...
meanCmsCommentsControllers.controller('CommentEditCtrl', ['$scope', "$routeParams", 'checkCreds', 'Comment', '$location', '$http', 'getToken',
...
meanCmsCommentsControllers.controller('DeleteCommentCtrl', ['$scope', '$rootScope', 'Comment', '$location', '$route', '$http', 'getToken',
