...
var meanCmsMailServerControllers = angular.module('meanCmsMailServerControllers', []);

meanCmsMailServerControllers.controller('MailServerCtrl', ['$scope', "$routeParams", 'checkCreds', 'MailServer', '$location', '$http', 'getToken',
...
meanCmsMailServerControllers.controller('MailServerEditCtrl', ['$scope', "$routeParams", 'checkCreds', 'MailServer', '$location', '$http', 'getToken',
