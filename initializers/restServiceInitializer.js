...
var meanUserService = require('../services/meanUserService');
...
exports.initialize = function(self, cacheControlUtility) {
    ...
    //user
    self.app.post('/rs/user', meanUserService.create);
    self.app.put('/rs/user', meanUserService.update);
    self.app.delete('/rs/user/:id', meanUserService.delete);
    self.app.get('/rs/user/:id', meanUserService.get);
    self.app.post('/rs/user/list', meanUserService.list);
    self.app.post('/rs/user/pw', meanUserService.changePassword);
    self.app.post('/rs/user/roleList', meanUserService.roleList);
